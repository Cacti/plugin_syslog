...
Covers relative/custom search submission, Cacti dropdown state, reversed-range validation, escaped raw messages, inspector keyboard close, filter collapse, view options, refresh without detaching a saved search, and narrow-screen overflow.
