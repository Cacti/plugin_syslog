...
function disyplay_edit($text) {
	...
	print "
	<form action=syslog_remove.php method=post>
		<a name=edit>
		</a>
		<center>
			<h3>Add a Removal Rule</h3>
			<table cellspacing=0 cellpadding=1 bgcolor='#" . $colors["header"] . "'>
				<tr>
					<td>
						<table bgcolor='#" . $colors["header_panel"] . "'>
							<tr bgcolor='#" . $colors["header_panel"] . "'>
								<td class='textSubHeaderDark'>
									Name:
								</td>
								<td>
									<input type=text name=ename size=96>
								</td>
							</tr>
							<tr bgcolor='#" . $colors["header_panel"] . "'>
								<td class='textSubHeaderDark'>
	...
	print "
							...
							<tr bgcolor='#" . $colors["header_panel"] . "'>
								...
								<td>
									<input type=text name=etext size=96 value='$text'>
								</td>
							</tr>
							<tr bgcolor='#" . $colors["header_panel"] . "'>
								<td class='textSubHeaderDark' colspan=2>
									<center>
										<input type=image name=submit src='" . $config['url_path'] . "images/button_save.gif'>
									</center>
								</td>
							</tr>
						</table>
