...
* feature: Add a Syslog-owned durable replication outbox for configured Remote Data Collectors; locally archived records carry a collector-plus-source-event identity and portable payload for a future central receiver, while intentionally discarded records remain unreplicated
